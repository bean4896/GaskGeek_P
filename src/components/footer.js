    ...
    return (
        <div className='body-container mt-10'>
            ...
            <div className="flex flex-nowrap gap-4 dark:text-neutral-500 mt-5 ml-1">
                <div>Share To:</div>
                <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=gaskgeek.com" rel="noreferrer" className='textlink'>Facebook</a>
                <a target="_blank" href="https://twitter.com/intent/tweet?url=https://gaskgeek.com/&text=A%20curated%20resource%20to%20help%20you%20find%20trending%20design,%20inspiration%20and%20latest%20web%20technologies." rel="noreferrer" className='textlink'>Twitter</a>
            </div>
